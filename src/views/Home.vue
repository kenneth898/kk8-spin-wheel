<template>
	<div class="fix-mobile-size">
		<div class="new-personal">
			<img width="90%" src="/image/headline 4 1.webp">
		</div>
		<div class="language">
		...
		<div class="bg2">
			<img width="100%" src="/image/全网最大福利平台.webp"
				style="padding-top: 100px;   padding-right: 10px; padding-bottom: 100px;">
			<div class="image-bonus">
				<img width="100%" src="/image/photo (1).webp">
			</div>
